...
<html>
	...
	<!-- End Header -->
		...
		<section class="notice">
	    	...
	    	<!-- 하단넘버링 시작 -->
		     <ul class="page-num">
			      <a href="tList?page=1&searchTitle=${map.searchTitle}&searchWord=${map.searchWord}"><li class="first"></li></a>
			     
			      <c:if test="${map.page<=1}">
			      	<li class="prev"></li>
			      </c:if>
			      <c:if test="${map.page>1}">
			      	<a href="tList?page=${map.page-1}&searchTitle=${map.searchTitle}&searchWord=${map.searchWord}"><li class="prev"></li></a>
			      </c:if>
			      ...
			      <c:forEach var="i" begin="${map.startPage}" end="${map.endPage}" step="1">
				       ...
				       <c:if test="${map.page!=i}">
					       	<a href="tList?page=${i}&searchTitle=${map.searchTitle}&searchWord=${map.searchWord}">
			       ...
			       <c:if test="${map.page<map.maxPage}">
				      <a href="tList?page=${map.page+1}&searchTitle=${map.searchTitle}&searchWord=${map.searchWord}"><li class="next"></li></a>
			      </c:if>
			      <c:if test="${map.page>=map.maxPage}">
				     <li class="next"></li>
			      </c:if>
			      <a href="tList?page=${map.maxPage}&searchTitle=${map.searchTitle}&searchWord=${map.searchWord}"><li class="last"></li></a>
   			 </ul>
   			 <!-- 하단넘버링 끝 -->
		</section>
